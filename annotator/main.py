...
def run_annotator(vcf_path, output, total_cov_field, var_cov_field, sample_name = None, chunk_size = 200):
    """
    ...
    Args:
        ...
        chunk_size (int):      the maximum number of variants to submit per VEP API call. Default: 200
    ...
    with open(output, "w") as f:
        f.write("CHROM\tPOS\tREF\tALT\tFILTER\tN_VARIANT_READS\tTOTAL_READS\tVARIANT_READ_FRACTION\tVARIANT_TYPE\tGENE_ID\tGENE_SYMBOL\tTRANSCRIPT_ID\tIMPACT\tCONSEQUENCE_TERMS\tHGVSP\tDBSNP_ID\tCOSMIC_ID\tPOP_AF\n")
